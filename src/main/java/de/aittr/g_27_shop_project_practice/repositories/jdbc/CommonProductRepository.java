...
import de.aittr.g_27_shop_project_practice.repositories.interfaces.ProductRepository;
...
import static de.aittr.g_27_shop_project_practice.repositories.jdbc.DBConnector.getConnection;
@Repository
public class CommonProductRepository implements ProductRepository {
    ...
    public List<Product> getAll() {
        try (Connection connection = getConnection()){
            String query = "SELECT id, name, price FROM 27_shop.product where is_active = 1;";
            ResultSet resultSet = connection.createStatement().executeQuery(query);
